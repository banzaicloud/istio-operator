...
type BaseKubernetesResourceConfig struct {
	...
	PodAnnotations map[string]string `protobuf:"bytes,15,rep,name=podAnnotations,proto3" json:"podAnnotations,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
...
func (m *BaseKubernetesResourceConfig) GetPodAnnotations() map[string]string {
	if m != nil {
...
func init() {
	...
	proto.RegisterMapType((map[string]string)(nil), "istio_operator.v2.api.v1alpha1.BaseKubernetesResourceConfig.PodAnnotationsEntry")
...
var fileDescriptor_53057eb05156167c = []byte{
	...
	,
}
