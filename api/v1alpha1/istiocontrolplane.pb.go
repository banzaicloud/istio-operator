...
type IstioControlPlaneSpec struct {
	...
	// Default deployment spec for Istio control plane components.
	// Each component can overwrite these default values by adding its own deployment
	// block in the relevant section below and setting the desired values.
	K8S *BaseKubernetesResourceConfig `protobuf:"bytes,2,opt,name=k8s,proto3" json:"k8s,omitempty"`
	// Logging configurations.
	Logging *LoggingConfiguration `protobuf:"bytes,3,opt,name=logging,proto3" json:"logging"`
	...
	DefaultPodDisruptionBudget *PDBConfiguration `protobuf:"bytes,12,opt,name=defaultPodDisruptionBudget,proto3" json:"defaultPodDisruptionBudget"`
	// Configure the policy for validating JWT.
	// Currently, two options are supported: "third-party-jwt" and "first-party-jwt".
	// +kubebuilder:validation:Enum=THIRD_PARTY_JWT;FIRST_PARTY_JWT
	JwtPolicy JWTPolicyType `protobuf:"varint,13,opt,name=jwtPolicy,proto3,enum=istio_operator.v2.api.v1alpha1.JWTPolicyType" json:"jwtPolicy"`
	// The customized CA address to retrieve certificates for the pods in the cluster.
	// CSR clients such as the Istio Agent and ingress gateways can use this to specify the CA endpoint.
	CaAddress string `protobuf:"bytes,14,opt,name=caAddress,proto3" json:"caAddress"`
	// Upstream HTTP proxy properties to be injected as environment variables to the pod containers.
	HttpProxyEnvs *HTTPProxyEnvsConfiguration `protobuf:"bytes,15,opt,name=httpProxyEnvs,proto3" json:"httpProxyEnvs"`
...
func (m *IstioControlPlaneSpec) GetK8S() *BaseKubernetesResourceConfig {
	if m != nil {
		return m.K8S
	}
	return nil
...
var fileDescriptor_6817de833805cb8b = []byte{
	...
	,
}
...
func (m *IstioControlPlaneSpec) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			if m.K8S == nil {
				m.K8S = &BaseKubernetesResourceConfig{}
			}
