...
// DeepCopyInto supports using Templates within kubernetes types, where deepcopy-gen is used.
func (in *Templates) DeepCopyInto(out *Templates) {
	p := proto.Clone(in).(*Templates)
	*out = *p
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new Templates. Required by controller-gen.
...
// DeepCopyInterface is an autogenerated deepcopy function, copying the receiver, creating a new Templates. Required by controller-gen.
func (in *Templates) DeepCopyInterface() interface{} {
	return in.DeepCopy()
}
