...
// DeepCopyInto supports using MeshExpansionConfiguration_MeshGatewayConfiguration within kubernetes types, where deepcopy-gen is used.
func (in *MeshExpansionConfiguration_MeshGatewayConfiguration) DeepCopyInto(out *MeshExpansionConfiguration_MeshGatewayConfiguration) {
	p := proto.Clone(in).(*MeshExpansionConfiguration_MeshGatewayConfiguration)
	*out = *p
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MeshExpansionConfiguration_MeshGatewayConfiguration. Required by controller-gen.
func (in *MeshExpansionConfiguration_MeshGatewayConfiguration) DeepCopy() *MeshExpansionConfiguration_MeshGatewayConfiguration {
	if in == nil {
		return nil
	}
	out := new(MeshExpansionConfiguration_MeshGatewayConfiguration)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInterface is an autogenerated deepcopy function, copying the receiver, creating a new MeshExpansionConfiguration_MeshGatewayConfiguration. Required by controller-gen.
func (in *MeshExpansionConfiguration_MeshGatewayConfiguration) DeepCopyInterface() interface{} {
	return in.DeepCopy()
}
