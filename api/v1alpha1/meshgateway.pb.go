...
type MeshGatewayConfiguration struct {
	...
	// TODO! ServiceType missing from proto
	...
	// TODO! ServiceExternalTrafficPolicy missing from proto
	// +kubebuilder:validation:Enum=Local;Cluster
	// ServiceExternalTrafficPolicy corev1.ServiceExternalTrafficPolicyType `json:"serviceExternalTrafficPolicy,omitempty"`
	SDS *GatewaySDSConfiguration `protobuf:"bytes,6,opt,name=SDS,proto3" json:"sds,omitempty"`
	//
	RequestedNetworkView string `protobuf:"bytes,7,opt,name=RequestedNetworkView,proto3" json:"requestedNetworkView,omitempty"`
	// If present will be appended to the environment variables of the container
	AdditionalEnvVars []v1.EnvVar `protobuf:"bytes,8,rep,name=AdditionalEnvVars,proto3" json:"additionalEnvVars,omitempty"`
	// Whether to run the gateway in a privileged container
	RunAsRoot            bool     `protobuf:"varint,9,opt,name=RunAsRoot,proto3" json:"runAsRoot,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
var fileDescriptor_fdd75a369aea761c = []byte{
	...
	,
}
