...
// +kubebuilder:rbac:groups="servicemesh.cisco.com",resources=istiocontrolplanes/finalizers,verbs=create;update;patch;delete
// +kubebuilder:rbac:groups="servicemesh.cisco.com",resources=istiomeshgateways/finalizers,verbs=create;update;patch;delete
// +kubebuilder:rbac:groups="servicemesh.cisco.com",resources=istiomeshes/finalizers,verbs=create;update;patch;delete
// +kubebuilder:rbac:groups="servicemesh.cisco.com",resources=peeristiocontrolplanes/finalizers,verbs=create;update;patch;delete
