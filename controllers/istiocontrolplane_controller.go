...
// +kubebuilder:rbac:groups="servicemesh.cisco.com",resources=istiocontrolplanes/finalizers,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups="servicemesh.cisco.com",resources=istiomeshgateways/finalizers,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups="servicemesh.cisco.com",resources=istiomeshes/finalizers,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups="servicemesh.cisco.com",resources=peeristiocontrolplanes/finalizers,verbs=get;list;watch;create;update;patch;delete
