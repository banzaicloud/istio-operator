...
Here are the high level steps necessary to accomplish this through the canary upgrade flow:
...
This is a very important part and the reason why the data plane migration can be done gradually, because the communication works even between pods on different control planes.
