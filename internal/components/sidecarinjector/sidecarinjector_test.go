...
func TestICPSidecarInjectorResourceDump(t *testing.T) {
	t.Parallel()
	...
	reconciler := sidecarinjector.NewChartReconciler(
...
func TestICPSidecarInjectorValuesTemplateTransform(t *testing.T) {
	t.Parallel()
	...
	values, err := util.TransformStructToStriMapWithTemplate(icp, assets.IstioSidecarInjector, "values.yaml.tpl")
	if err != nil {
