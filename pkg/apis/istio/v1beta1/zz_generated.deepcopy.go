...
func (in *CNITaintConfiguration) DeepCopy() *CNITaintConfiguration {
	if in == nil {
		return nil
	}
	out := new(CNITaintConfiguration)
	in.DeepCopyInto(out)
	return out
}
...
func (in *IstioSpec) DeepCopyInto(out *IstioSpec) {
	*out = *in
	...
	if in.MultiMeshExpansion != nil {
		in, out := &in.MultiMeshExpansion, &out.MultiMeshExpansion
		*out = new(MultiMeshConfiguration)
		(*in).DeepCopyInto(*out)
	}
...
func (in *IstiodCAConfiguration) DeepCopyInto(out *IstiodCAConfiguration) {
	*out = *in
	if in.Vault != nil {
		...
		*out = new(VaultCAConfiguration)
		(*in).DeepCopyInto(*out)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new IstiodCAConfiguration.
func (in *IstiodCAConfiguration) DeepCopy() *IstiodCAConfiguration {
	if in == nil {
		return nil
	}
	out := new(IstiodCAConfiguration)
	in.DeepCopyInto(out)
	return out
}
...
func (in *IstiodConfiguration) DeepCopyInto(out *IstiodConfiguration) {
	*out = *in
	...
	if in.ExposeWebhookPort != nil {
		in, out := &in.ExposeWebhookPort, &out.ExposeWebhookPort
		*out = new(bool)
		**out = **in
	}
...
func (in *MultiMeshConfiguration) DeepCopyInto(out *MultiMeshConfiguration) {
	*out = *in
	...
	if in.EnvoyFilterEnabled != nil {
		in, out := &in.EnvoyFilterEnabled, &out.EnvoyFilterEnabled
		*out = new(bool)
		**out = **in
	}
	if in.Domains != nil {
...
func (in *MultiMeshConfiguration) DeepCopy() *MultiMeshConfiguration {
	if in == nil {
		return nil
	}
	out := new(MultiMeshConfiguration)
...
func (in *SPIFFEConfiguration) DeepCopyInto(out *SPIFFEConfiguration) {
	*out = *in
	if in.OperatorEndpoints != nil {
		in, out := &in.OperatorEndpoints, &out.OperatorEndpoints
		*out = new(OperatorEndpointsConfiguration)
		(*in).DeepCopyInto(*out)
	}
}
...
func (in SortableIstioItems) DeepCopyInto(out *SortableIstioItems) {
	{
		in := &in
		*out = make(SortableIstioItems, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *VaultCAConfiguration) DeepCopyInto(out *VaultCAConfiguration) {
	*out = *in
	...
	if in.CertChainPath != nil {
		in, out := &in.CertChainPath, &out.CertChainPath
		*out = new(string)
		**out = **in
	}
	if in.VaultEnvImage != nil {
		in, out := &in.VaultEnvImage, &out.VaultEnvImage
		*out = new(string)
		**out = **in
	}
}
...
func (in *VaultCAConfiguration) DeepCopy() *VaultCAConfiguration {
	if in == nil {
		return nil
	}
	out := new(VaultCAConfiguration)
