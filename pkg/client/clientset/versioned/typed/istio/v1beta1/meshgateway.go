...
func (c *meshGateways) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.MeshGateway, err error) {
...
func (c *meshGateways) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.MeshGatewayList, err error) {
...
func (c *meshGateways) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *meshGateways) Create(ctx context.Context, meshGateway *v1beta1.MeshGateway, opts v1.CreateOptions) (result *v1beta1.MeshGateway, err error) {
	result = &v1beta1.MeshGateway{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("meshgateways").
...
func (c *meshGateways) Update(ctx context.Context, meshGateway *v1beta1.MeshGateway, opts v1.UpdateOptions) (result *v1beta1.MeshGateway, err error) {
	result = &v1beta1.MeshGateway{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("meshgateways").
...
func (c *meshGateways) UpdateStatus(ctx context.Context, meshGateway *v1beta1.MeshGateway, opts v1.UpdateOptions) (result *v1beta1.MeshGateway, err error) {
	result = &v1beta1.MeshGateway{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("meshgateways").
...
func (c *meshGateways) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *meshGateways) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *meshGateways) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.MeshGateway, err error) {
	result = &v1beta1.MeshGateway{}
