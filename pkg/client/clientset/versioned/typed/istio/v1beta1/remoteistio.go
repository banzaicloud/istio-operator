...
func (c *remoteIstios) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.RemoteIstio, err error) {
...
func (c *remoteIstios) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.RemoteIstioList, err error) {
...
func (c *remoteIstios) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *remoteIstios) Create(ctx context.Context, remoteIstio *v1beta1.RemoteIstio, opts v1.CreateOptions) (result *v1beta1.RemoteIstio, err error) {
	result = &v1beta1.RemoteIstio{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("remoteistios").
...
func (c *remoteIstios) Update(ctx context.Context, remoteIstio *v1beta1.RemoteIstio, opts v1.UpdateOptions) (result *v1beta1.RemoteIstio, err error) {
	result = &v1beta1.RemoteIstio{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("remoteistios").
...
func (c *remoteIstios) UpdateStatus(ctx context.Context, remoteIstio *v1beta1.RemoteIstio, opts v1.UpdateOptions) (result *v1beta1.RemoteIstio, err error) {
	result = &v1beta1.RemoteIstio{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("remoteistios").
...
func (c *remoteIstios) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *remoteIstios) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *remoteIstios) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.RemoteIstio, err error) {
	result = &v1beta1.RemoteIstio{}
