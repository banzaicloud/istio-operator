...
func (r *Reconciler) horizontalPodAutoscaler() runtime.Object {
	return &autoscalev2beta2.HorizontalPodAutoscaler{
		ObjectMeta: templates.ObjectMetaWithRevision(hpaName, labelSelector, r.Config),
		Spec: autoscalev2beta2.HorizontalPodAutoscalerSpec{
			MaxReplicas: util.PointerToInt32(r.Config.Spec.IstioCoreDNS.MaxReplicas),
			MinReplicas: r.Config.Spec.IstioCoreDNS.MinReplicas,
