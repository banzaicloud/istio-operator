...
// If kubeConfigPath is provided, loads configuration from that file. Otherwise,
// GetConfigWithContext uses default strategy to load configuration from $KUBECONFIG,
